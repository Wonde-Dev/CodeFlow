    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          ...
          <p className="text-muted text-base text-xl sm:text-lg max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-6">
          {plans.map((plan, key) => (
            <div
              key={key}
              className={`relative bg-surface-theme/50 backdrop-blur-sm border border-theme/30 rounded-xl sm:rounded-2xl p-6 sm:p-8 transition-all duration-300 overflow-visible group flex flex-col h-full ${
                plan.mostPopular
                  ? "border-blue-500 shadow-2xl shadow-blue-500/20 lg:scale-105"
                  : "border-theme/50 hover:border-theme/70"
              }`}
            >
                ...
                <div className="flex items-baseline justify-center">
                  ...
                  >
                    ${plan.price}
                     ...
                     <span className="text-muted ml-1 sm:ml-2 text-sm sm:text-base">
                       /month
                     </span>
                </div>
              </div>
              ...
              <button
                className={`w-full py-2.5 sm:py-3 px-4 sm:px-6 rounded-lg font-semibold transition-all duration-300 mt-auto hover:scale-102 cursor-pointer text-sm sm:text-base ${
                  plan.mostPopular
                    ...
                    : "overlay-glass text-theme hover:overlay-glass-hover"
                }`}
              >
                Get Started
              </button>
        ...
        <div className="mt-8 sm:mt-12 text-center">
          <p className="text-muted text-base text-xl">
            Need a custom plan?{" "}
