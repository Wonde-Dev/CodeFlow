          ...
          <div className="lg:w-1/2 w-full">
            <div className="space-y-6 sm:space-y-8">
               {testimonials.map((testimonial, key) => (
                 <div
                   key={key}
                   className="bg-surface-theme/50 p-4 sm:p-6 backdrop-blur-sm border border-theme/30 rounded-xl sm:rounded-2xl"
                 >
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    ...
                    <div className="flex-grow">
                       <p className="text-theme text-base sm:text-lg leading-relaxed mb-3 sm:mb-4">
                         {testimonial.content}
                       </p>
                      <div className="flex items-center space-x-2 sm:space-x-3">
                        ...
                        />
                        <div>
                           <h4 className="font-semibold text-theme text-sm sm:text-base">
                             {testimonial.name}
                           </h4>
