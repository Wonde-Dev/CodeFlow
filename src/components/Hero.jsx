      ...
      <div className="max-w-7xl mx-auto text-center relative w-full">
        <div className="max-w-7xl mx-auto flex flex-col lg:grid lg:grid-cols-2 text-center lg:text-left gap-6 sm:gap-8 lg:gap-12 items-center relative">
          <div>
            ...
            <p className="text-md sm:text-base lg:text-lg text-muted max-w-2xl mx-auto lg:mx-0 mb-6 sm:mb-8 animate-in slide-in-from-bottom duration-700 delay-200 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 sm:gap-4 mb-8 sm:mb-12 animate-in slide-in-from-bottom duration-700 delay-300">
              <button className="group w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-b from-blue-600 to-blue-400 rounded-lg font-semibold text-sm sm:text-base transition-all duration-300 hover:scale-102 flex items-center justify-center space-x-2">
                ...
                <button className="group w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 overlay-glass overlay-glass-hover rounded-lg font-semibold text-sm sm:text-base transition-all duration-300 hover:scale-102 flex items-center justify-center space-x-2">
                 <div className="p-2 overlay-glass rounded-full group-hover:overlay-hover duration-300 transition-colors">
          ...
          <div className="relative order-2 w-full">
            <div className="relative bg-surface-theme/5 backdrop-blur-xl rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-2xl border border-theme/20">
                <div className="bg-surface-theme/10 backdrop-blur-sm rounded-lg overflow-hidden h-[280px] sm:h-[350px] lg:h-[450px] border border-theme/30">
                {/* IDE HEADER */}
                <div className="flex items-center justify-between px-3 sm:px-4 py-2 sm:py-3 surface-theme/10 backdrop-blur-sm border-b border-theme/20">
                  ...
                  <ChevronDown className="w-3 h-3 sm:w-4 sm:h-4 text-muted" />
                </div>
                  ...
                  <div className="flex space-x-1 sm:space-x-2 mb-3 sm:mb-4 overflow-x-auto">
                    <button
                      ...
                      className={`px-3 py-2 backdrop-blur-sm text-xs sm:text-sm rounded-t-lg border ${
                        activeTab === "App.jsx"
                          ? "surface-theme border-theme/30 text-theme"
                          : "overlay-glass text-muted hover:overlay-glass-hover"
              ...
              {/* Floating Cards */}
               <div
                 className={`hidden lg:block absolute bottom-4 right-4 transform translate-x-8 translate-y-8 w-72 ${currentFloatingCard.bgColor} backdrop-blur-xl rounded-lg p-4 border border-theme/30 shadow-2xl`}
               >
